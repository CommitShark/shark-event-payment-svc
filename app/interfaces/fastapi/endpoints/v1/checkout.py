...
from app.application.dto.checkout import CreateCheckoutReqDto, CreateCheckoutResDto
from app.interfaces.fastapi.context import UserContextDep, ProtectedDep
from app.interfaces.fastapi.di import CreateCheckoutUseCaseDep

router = APIRouter(prefix="/v1/checkout", tags=["Checkout"])


@router.post("/ticket-purchase", response_model=CreateCheckoutResDto)
